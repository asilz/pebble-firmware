...
static char s_local_device_name[BT_DEVICE_NAME_BUFFER_SIZE] = "Asil";
static char s_local_le_device_name[BT_DEVICE_NAME_BUFFER_SIZE] = "AsilLE";
...
void bt_local_id_copy_device_name(char name_out[BT_DEVICE_NAME_BUFFER_SIZE], bool is_le) {
  char *name =
      (is_le && bt_driver_supports_bt_classic()) ? s_local_le_device_name : s_local_device_name;
